#
#  Be sure to run `pod spec lint ZKCornerRadiusView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zhenkai zhao"
  # s.authors            = { "zhenkai zhao" => "zhenkai.zhao@2ccm.com" }
  # s.social_media_url   = "http://twitter.com/zhenkai zhao"
  ...
  s.source       = { :git => "https://github.com/superk589/ZKCornerRadiusView.git", :tag => "0.0.1" }
